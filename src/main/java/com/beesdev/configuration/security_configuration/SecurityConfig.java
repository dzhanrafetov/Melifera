package com.beesdev.configuration.security_configuration;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeRequests().antMatchers("/v1/user/admin/**")
                .hasRole("ADMIN")
                ...
                .antMatchers("/v1/user/showUserForm*").permitAll() // Permit access to the registration page
